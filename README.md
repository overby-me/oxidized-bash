...
> [`safety/oxidized/bash`](https://tangled.org/overby.me/overby.me/tree/main/safety/oxidized/bash) and where all development happens.
>
> It is also published on its own, as
> [tangled.org/overby.me/oxidized-bash](https://tangled.org/overby.me/oxidized-bash) and
> [github.com/overby-me/oxidized-bash](https://github.com/overby-me/oxidized-bash). Both
