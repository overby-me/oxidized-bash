...
> [`safety/oxidized/bash`](https://tangled.org/overby.me/overby.me/tree/main/rust/bash) and where all development happens.
>
> It is also published on its own, as
> [tangled.org/overby.me/rust-bash](https://tangled.org/overby.me/rust-bash) and
> [github.com/overby-me/rust-bash](https://github.com/overby-me/rust-bash). Both
